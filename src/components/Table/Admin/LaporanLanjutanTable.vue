  ...
  <table>
    <thead>
      <tr>
        ...
        <th>Pihak Pelaksana</th>
        <th>Teknisi Pengawas</th>
      </tr>
    </thead>
    <tbody>
      <tr
      ...
      >
        ...
        <td data-label="Id Laporan">
          {{ client.laporan }}
        </td>
        <td data-label="Tanggal Perbaikan">
          <small
            class="text-gray-500 dark:text-gray-400"
            :title="client.tanggalPerbaikan"
          >{{ convertDate(client.tanggalPerbaikan) }}</small>
        </td>
        <td data-label="Pihak Pelaksana">
          {{ client.pelaksana }}
        </td>
        <td data-label="Teknisi Pengawas">
          {{ teknisi.find( n => n.id == client.teknisi).nama }}
        </td>
      </tr>
    </tbody>
  </table>
