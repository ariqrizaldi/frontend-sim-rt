...
<template>
  <aside
    v-show="!isFullScreen"
    id="aside"
    class="w-60 fixed shadow-lg top-0 z-40 h-screen transition-position lg:left-0
  ...
  >
    <div
      class="flex flex-row shadow-md w-full flex-1 h-14 items-center dark:bg-transparent"
